...
{
    constexpr const char* shaderFiles[7] = {
        "projects/program/source/prototype2/shaders/position_only.vert",
        "projects/program/source/prototype2/shaders/position_only.frag",
        "projects/program/source/prototype2/shaders/shader.vert",
        "projects/program/source/prototype2/shaders/shader.frag",
        "projects/program/source/prototype2/shaders/stagger.comp",
        "projects/program/source/prototype2/shaders/boundarypass.comp",
        "projects/program/source/prototype2/shaders/advect.comp"
    };
    const std::array<ShaderData, 7> shaderMetadata = {{
        ...
        { shaderFiles[6], __scast(u32, gl::GL_COMPUTE_SHADER )}
    }};
    ...
    mr_applyBoundaryCnd.createFrom({ shaderMetadata[5] });
    mr_advect.createFrom          ({ shaderMetadata[6] });
